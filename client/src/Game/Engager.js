              ...
              <div className='emoji'>
                ...
                <div className="total"
                    onClick={func => this.showReactors(
                      ...
                      , react: "angry"})}
                >{this.state.reacts.angry.total + this.state.angry}</div>
              </div>
              <div className='emoji'>
                ...
                <div className="total"
                    onClick={func => this.showReactors(
                      ...
                      , react: "cry"})}
                >{this.state.reacts.cry.total + this.state.cry}</div>
              </div>
              <div className='emoji'>
                ...
                <div className="total"
                    onClick={func => this.showReactors(
                      ...
                      , react: "sleep"})}
                  >{this.state.reacts.sleep.total + this.state.sleep}</div>
              </div>
              <div className='emoji'>
                ...
                <div className="total"
                    onClick={func => this.showReactors(
                      ...
                      , react: "shocked"})}
                >{this.state.reacts.shocked.total + this.state.shocked}</div>
              </div>
              <div className='emoji'>
                ...
                <div className="total"
                   onClick={func => this.showReactors(
                     ...
                     , react: "tongue"})}
                >{this.state.reacts.tongue.total + this.state.tongue}</div>
              </div>
              <div className='emoji'>
                ...
                <div className="total"
                    onClick={func => this.showReactors(
                      ...
                      , react: "cool"})}
                >{this.state.reacts.cool.total + this.state.cool}</div>
              </div>
              <div className='emoji'>
